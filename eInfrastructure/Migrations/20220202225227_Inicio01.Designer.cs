...
namespace eInfrastructure.Migrations
{
    ...
    [Migration("20220202225227_Inicio01")]
            ...
            modelBuilder.Entity("eInfrastructure.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdUsuario = 1,
                            Cedula = "ADM001",
                            Contraseña = "$2a$11$4sefB4KWR/G7dNvkI4Kpn.LNqWqvEckyOJvodaE6hLeKj3GPHSmwy",
                            Correo = "vicram10@gmail.com",
                            FechaRegistro = new DateTime(2022, 2, 2, 19, 52, 27, 545, DateTimeKind.Local).AddTicks(2622),
                            IdEstado = 1,
                            IdUsuarioRegistro = 1,
                            IdiomaElegido = "ES",
