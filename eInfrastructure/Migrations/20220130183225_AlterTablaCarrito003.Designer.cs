...
namespace eInfrastructure.Migrations
{
    ...
    [Migration("20220130183225_AlterTablaCarrito003")]
    partial class AlterTablaCarrito003
    {
            ...
            modelBuilder.Entity("eInfrastructure.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdUsuario = 1,
                            Cedula = "ADM001",
                            Contraseña = "$2a$11$.z8IYJ.lr58BjSz4RiqyheVbKGgxAWHYbpP7n0HlNYNJeEiKsy5n.",
                            Correo = "vicram10@gmail.com",
                            FechaRegistro = new DateTime(2022, 1, 30, 15, 32, 25, 85, DateTimeKind.Local).AddTicks(8747),
                            IdEstado = 1,
                            IdUsuarioRegistro = 1,
                            IdiomaElegido = "ES",
