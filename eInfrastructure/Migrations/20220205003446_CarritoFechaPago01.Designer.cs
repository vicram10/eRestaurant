...
namespace eInfrastructure.Migrations
{
    ...
    [Migration("20220205003446_CarritoFechaPago01")]
    partial class CarritoFechaPago01
    {
            ...
            modelBuilder.Entity("eInfrastructure.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdUsuario = 1,
                            Cedula = "ADM001",
                            Contraseña = "$2a$11$VVjEd4utxUieu9.wPQzpGe/8AhQi2fBh6rChzMQONPj5VyiGFxI3G",
                            Correo = "vicram10@gmail.com",
                            FechaRegistro = new DateTime(2022, 2, 4, 21, 34, 46, 255, DateTimeKind.Local).AddTicks(3822),
                            IdEstado = 1,
                            IdUsuarioRegistro = 1,
                            IdiomaElegido = "ES",
